        ...
        subdomains: [
          {
            ...
            descriptions: {
              Emerging: "Description: There is awareness of Gen AI potential but no clear alignment with educational objectives. Evidence: Gen AI initiatives are considered without a direct link to the district's mission or goals. Recommendations: Begin aligning Gen AI efforts with the districts broader educational objectives.",
              ...
              Mature: "Description: Gen AI initiatives are fully aligned with and integral to educational objectives. Evidence: Gen AI is a key component in fulfilling the districts mission and educational goals. Continue to innovate and ensure that Gen AI initiatives evolve with educational objectives.",
            },
          },
          {
            id: "1.1.2",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There are sophisticated metrics and financial models for Gen AI impact evaluation. Evidence: Gen AI impact and financial aspects are thoroughly evaluated and inform decision-making. Continuously refine metrics and financial models to accurately assess Gen AI's evolving impact.",
            },
          },
        ],
      },
        ...
        subdomains: [
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There is full compliance with legal and regulatory frameworks for Gen AI. Evidence: Gen AI usage fully adheres to state laws and district rules. Maintain and continuously update compliance measures as legal standards evolve.",
            },
          },
          {
            id: "1.2.2",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There are comprehensive and proactive education and policy updates for the School Board. Evidence: The School Board is fully involved and kept up-todate on all aspects of Gen AI. Sustain and evolve the board's education and involvement with ongoing Gen AI advancements.",
            },
          },
        ],
      },
        ...
        subdomains: [
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There is advanced prioritization of data management and privacy in all AI procurements. Evidence: Data management and privacy are central to AI tool procurement processes. Recommendations: Continue to lead in data management and privacy practices, adapting to new challenges and technologies. 2. Operational Readiness Operational Readiness in the context of Gen AI encompasses the essential organizational processes and human resource considerations necessary to successfully adopt and integrate AI technologies in school districts. The Maturity Rubric for this domain includes:",
            },
          },
        ],
      },
    ...
    sections: [
      {
        ...
        subdomains: [
          ...
          },
          {
            ...
            descriptions: {
              Emerging: "Description: The district is in the initial stages of acknowledging the need for compliance in procurement processes. Lack of structured review and approval systems. Procurement processes for Gen AI tools are irregular and not consistently aligned with standards. Recommendations: Establish basic compliance procedures and review mechanisms for procurement processes.",
              Developing: "Description: Implementation of compliance standards in procurement processes is improving, but not yet fully comprehensive. Procurement processes are increasingly adhering to standards, but some inconsistencies remain. Recommendations: Enhance the standardization and thoroughness of compliance and review processes for Gen AI tool procurement.",
              Mature: "Description: There are comprehensive and wellestablished compliance standards and review processes for Gen AI procurement. Procurement processes are consistently executed with high adherence to established standards. Recommendations: Continuously monitor, review, and update procurement compliance procedures to ensure ongoing alignment with best practices and evolving standards.",
            },
          },
          {
            id: "2.1.3",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There are comprehensive requirements for vendor notification about Gen AI enhancements. Evidence: Systematic and effective communication from vendors regarding Gen AI capabilities. Continuously evaluate and update vendor notification protocols to reflect current Gen AI developments.",
            },
          },
          {
            id: "2.1.5",
            ...
            descriptions: {
              ...
              Mature: "Description: There is advanced integration of data management and privacy into procurement decisions. Data management and privacy are central and consistent elements of the procurement process. Recommendations: Continually lead and adapt data management and privacy practices in line with evolving technologies and standards.",
            },
          },
          {
            id: "2.1.6",
            ...
            descriptions: {
              ...
              Developing: "Description: Practices for managing vendor relationships with a focus on Gen AI alignment are developing. Management of vendor relationships have improved, but are not fully aligned with Gen AI objectives. Recommendations: Enhance guidelines and practices for vendor relationship management, focusing on continuous alignment with district goals.",
              Mature: "Description: Management of vendor relationships is comprehensive and fully aligned with Gen AI goals and district standards. Effective and strategic vendor relationship management is in line with Gen AI objectives. Recommendations: Continuously review and evolve vendor management strategies to maintain alignment with district goals and Gen AI advancements.",
            },
          },
          {
            id: "2.1.7",
        ...
        subdomains: [
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There are advanced skill development programs for data management in Gen AI contexts. Evidence: Staff possess comprehensive data management skills suitable for Gen AI applications. Recommendations: Regularly update and enhance training programs to keep staff skills aligned with the latest Gen AI data management trends. 3. Data Readiness Data Readiness ensures the school district is prepared for Gen AI implementation with robust data governance, quality, and privacy measures, coupled with effective identity and access management, tracking, technical control, and security safeguards. The Maturity Rubric for this domain includes:",
            },
          },
        ],
      },
        ...
        subdomains: [
          {
            ...
            descriptions: {
              ...
              Developing: "Description: Structured roles for data stewardship and ownership are developing, but not fully comprehensive. The assignment of data management responsibilities is improving, but some gaps remain. Recommendations: Enhance and clarify roles for data stewardship and ownership to cover all critical data assets.",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There are comprehensive and systematic approaches to data storage and classification. Evidence: Data is efficiently organized and accessible, with robust classification systems in place. Continuously review and update data storage and classification protocols to align with evolving data requirements and technologies.",
            },
          },
          {
            id: "3.1.4",
            ...
            descriptions: {
              Emerging: "Description: There is limited management of data asset lifecycles, with informal or inconsistent practices. Lifecycle management of data assets is inadequate, resulting in inefficiencies and potential data loss. Recommendations: Develop basic asset lifecycle management practices to better manage data from creation to disposal.",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Developing: "Description: Processes and policies for data lifecycle management are developing, but not yet fully systematic. Some improvements in data lifecycle management exist, but comprehensive coverage is lacking. Enhance and standardize data lifecycle management practices to ensure data integrity and compliance.",
              Mature: "Description: Management of the data lifecycle is comprehensive and systematic, ensuring data integrity and compliance. Robust practices are in place for managing data throughout its lifecycle, with strong adherence to policies. Continuously review and update data lifecycle management policies to stay aligned with evolving data needs and regulations.",
            },
          },
          {
            id: "3.1.6",
      ...
      },
      {
        ...
        subdomains: [
          ...
          },
          {
            ...
            descriptions: {
              Emerging: "Description: Management of data versions and sources is ad-hoc, with minimal tracking. Tracking data changes and sources is difficult, leading to potential data integrity issues. Recommendations: Start implementing versioning controls and source identification for data.",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There is a comprehensive approach to ensuring all data is in a machinereadable format compatible with Gen AI. Evidence: Data formats are uniformly suitable for Gen AI, facilitating efficient use. Continuously adapt data formats to align with evolving Gen AI technologies and standards.",
            },
          },
          {
            id: "3.2.4",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: Comprehensive data integrity programs are in place, with systematic audits and validation. Evidence: High levels of data integrity are maintained through regular and thorough audits and validation. Continuously review and adapt data integrity programs to align with evolving data needs and technologies.",
            },
          },
        ],
      },
        ...
        subdomains: [
          {
            ...
            descriptions: {
              Emerging: "Description: Vendors have been assessed at a basic level for data privacy practices, with limited vetting processes. Evidence: Vendors are vetted inconsistently, leading t o potential privacy risks. Recommendations: Develop initial vetting procedures to assess vendors' data privacy practices.",
          ...
          },
          {
            ...
            descriptions: {
              Emerging: "Description: There are infrequent updates to privacy policies and minimal staff training on compliance. Staff are not fully aware or trained on updated privacy policies. Recommendations: Initiate regular updates to privacy policies and implement basic training programs for staff.",
              Developing: "Description: Progress in updating privacy policies and staff training is developing, but not yet fully systematic. Focus on privacy policy updates and training is increasing, but inconsistencies in staff knowledge and compliance persist. Recommendations: Strengthen the frequency and depth of privacy policy updates and staff training programs.",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There is comprehensive and systematic third-party auditing and contractual enforcement for data privacy. Evidence: Consistent and effective enforcement of data privacy exists in all third-party contracts and regular audits. Continuously review and update auditing and contractual practices to maintain high standards of data privacy.",
            },
          },
          {
            id: "3.3.4",
            ...
            descriptions: {
              Emerging: "Description: There is an awareness of privacy by design principles, but limited integration into Gen AI initiatives. Privacy considerations are not systematically incorporated into Gen AI-related projects. Recommendations: Start integrating privacy by design principles in the early stages of Gen AI-related initiatives.",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Developing: "Description: A more structured approach to privacy impact assessments is developing, but not yet fully integrated into all new initiatives. Evidence: Some privacy assessments have been conducted, but coverage and depth are not sufficient. Enhance the scope and frequency of privacy impact assessments to cover all new technologies and policies.",
              Mature: "Description: Comprehensive and regular privacy impact assessments are integrated into all new technology and policy implementations. Evidence: Privacy risks are effectively identified and mitigated in all new initiatives. Continuously adapt and refine privacy impact assessment processes to align with emerging technologies and evolving privacy concerns. 4. Technical Readiness The Technical Readiness domain ensures that the district's technological infrastructure and practices are primed for the effective and secure implementation of Gen AI. This domain encompasses aspects such as identity and access management, system monitoring, technical controls, and content moderation, focusing on establishing robust policies and systems to support the responsible and efficient use of Gen AI technologies in the educational sector. It emphasizes the need for rigorous policy development, system oversight, technical safeguard implementation, and the management of digital content to facilitate a secure and effective deployment of Gen AI tools. The Maturity Rubric for this domain includes:",
            },
          },
        ],
      },
        ...
        subdomains: [
          {
            ...
            descriptions: {
              ...
              Mature: "Description: Comprehensive and well-structured role-based access control systems are in place. Evidence: Role-based access controls are effectively managing user access and enhancing security and compliance. Continuously review and update access control systems to adapt to changing roles and security needs.",
            },
          },
          {
            id: "4.1.2",
            ...
            descriptions: {
              ...
              Mature: "Description: A full and seamless integration of Gen AI tools with existing authentication systems is in place. Evidence: Gen AI tools are consistently secure and aligned with authentication protocols. Maintain and continuously enhance the integration of Gen AI tools with authentication systems.",
            },
          },
          {
            id: "4.1.3",
            ...
            descriptions: {
              Emerging: "Description: Initial efforts to evaluate and adjust access controls exist, but processes are ad-hoc and reactive. Access controls are not consistently evaluated or updated, leading to security gaps. Recommendations: Develop a basic framework for ongoing evaluation and adjustment of access controls.",
              ...
              Mature: "Description: Comprehensive and proactive processes for continuous access evaluation and adjustment exist. Evidence: Access controls are regularly evaluated and adjusted, ensuring ongoing security and relevance. Continuously review and refine access evaluation processes to adapt to evolving user roles and system updates.",
            },
          },
          {
            id: "4.1.4",
        ...
        subdomains: [
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: Comprehensive and integrated automated compliance monitoring systems are in place for Gen AI tools. Evidence: Effective and consistent monitoring ensures compliance with district policies. Continuously review and enhance automated systems to adapt to evolving Gen AI technologies and policy changes.",
            },
          },
          {
            id: "4.2.4",
        ...
        subdomains: [
          ...
          },
          {
            ...
            descriptions: {
              ...
              Developing: "Description: More structured processes for assessing interoperability are developing, but not comprehensive. Some progress exists in ensuring compatibility, but gaps in interoperability assessments exist. Recommendations: Enhance the scope and thoroughness of interoperability assessments to ensure seamless integration.",
          ...
          },
          {
            ...
            descriptions: {
              Emerging: "Description: There is minimal consideration of the environmental impact of Gen AI tools, with limited focus on sustainability. Evidence: The sustainability and environmental impact of Gen AI tools are not adequately addressed. Initiate basic strategies to evaluate and minimize the environmental impact of Gen AI technologies.",
              Developing: "Description: A focus on sustainability and environmental impact is increasing, but practices are not fully integrated. Evidence: Awareness of sustainability is growing, but consist ent application across Gen AI tools is lacking. Recommendations: Strengthen sustainability strategies to cover all aspects of Gen AI tool deployment.",
              Mature: "Description: There is an advanced and integrated consideration of sustainability and environmental impact in all Gen AI tool deployments. Sustainability is a core aspect of Gen AI tool selection and usage, minimizing environmental impact. Recommendations: Regularly reassess and adapt sustainability strategies to align with current and future environmental standards.",
            },
          },
        ],
      },
        ...
        subdomains: [
          {
            ...
            descriptions: {
              Emerging: "Description: There is an initial establishment of content moderation systems, with limited human oversight. Evidence: Content moderation is inadequate, leading to potential exposure to inappropriate content. Recommendations: Develop basic content moderation systems wi th some level of human oversight.",
              Developing: "Description: More structured content moderation processes are developing, but not yet fully comprehensive. Content moderation is improved, but gaps in human oversight exist. Recommendations: Enhance content moderation systems and ensure consistent human oversight across all platforms.",
              Mature: "Description: Comprehensive and systematic content moderation systems are in place with robust human oversight. Evidence: There is effective management of inappropriate content with consistent human review and moderation. Continuously review and update content moderation systems to adapt to new challenges and technologies.",
            },
          },
          {
            id: "4.4.2",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Developing: "Description: More structured feedback and reporting systems are developing, but not yet fully effective. Reporting mechanisms are improved, but comprehensive and proactive feedback collection is lacking. Recommendations: Enhance feedback and reporting systems to encourage more active use and responsiveness.",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: There is strong and continuous engagement with the school community on content moderation in Gen AI. Evidence: There is a high level of community involvement and understanding of content moderation challenges. Maintain and deepen community engagement efforts to foster a collaborative approach to content moderation. 5. Security Readiness The Security Readiness domain is dedicated to establishing and maintaining robust security measures and practices in the context of Gen AI usage within a school district. This domain encompasses developing comprehensive cybersecurity frameworks, specific security protections tailored for Gen AI applications, and thorough cybersecurity training programs. It emphasizes the importance of having designated individuals responsible for cybersecurity, ensuring that security frameworks are comprehensive and include Gen AI-specific considerations, and providing role-based cybersecurity education. The focus is on creating a secure environment for Gen AI technologies, ensuring that all stakeholders are wellprepared to handle potential security challenges and threats in an educational setting. The Maturity Rubric for this domain includes:",
            },
          },
        ],
      },
        ...
        subdomains: [
          {
            ...
            descriptions: {
              ...
              Developing: "Description: More structured cybersecurity frameworks are developing, but not fully comprehensive. Improved cybersecurity governance exists, but gaps in framework effectiveness remain. Recommendations: Enhance cybersecurity frameworks and ensure they are comprehensive and regularly reviewed.",
              Mature: "Description: Comprehensive and well-established cybersecurity leadership and frameworks exist. Evidence: Cybersecurity is effectively governed and managed, ensuring robust protection. Continuously review and adapt cybersecurity frameworks to evolving threats and technologies.",
            },
          },
          {
            id: "5.1.2",
            ...
            descriptions: {
              ...
              Mature: "Description: Advanced and fully implemented Gen AI-specific security measures are in place. Gen AI applications are securely protected against a wide range of threats. Recommendations: Regularly update and refine Gen AI-specific security measures to stay ahead of emerging security challenges.",
            },
          },
          {
            id: "5.1.3",
            ...
            descriptions: {
              ...
              Developing: "Description: More structured incident response plans are developing, including some Gen AI-specific protocols. Some improvements in response readiness for Gen AI incidents have been made, but are not fully comprehensive. Recommendations: Enhance incident response planning to cover all potential Gen AIrelated security scenarios.",
        ...
        subdomains: [
          {
            ...
            descriptions: {
              ...
              Developing: "Description: More structured role-based cybersecurity training is developing, but not yet fully effective. Evidence: Role-specific training has improved, but gaps in coverage and depth remain. Enhance and standardize role-based cybersecurity training to cover all relevant roles.",
              Mature: "Description: Comprehensive rolebased cybersecurity education exists and is tailored to all organizational roles. Evidence: Consistent and effective cybersecurity knowl edge and practices are evident across all roles. Continuously review and adapt role-based training to changing cybersecurity needs and technologies.",
            },
          },
          {
            id: "5.2.2",
          ...
          },
          {
            ...
            descriptions: {
              Emerging: "Description: Initial efforts to establish a continuous learning framework for cybersecurity exist, but are lacking in depth and Gen AI focus. Cybersecurity training is not keeping pace with evolving trends and threats, especially in Gen AI. Recommendations: Develop a basic continuous learning framework that includes updates on Gen AI-related cybersecurity.",
              Developing: "Description: A more structured continuous learning framework is being developed, but there is only partial integration of Gen AI trends. Evidence: Some pro gress exists in updating cybersecurity training, but comprehensive coverage of Gen AI threats is needed. Enhance the continuous learning framework to fully integrate Gen AI trends and threats.",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: Advanced and widespread community awareness programs exist, effectively raising cybersecurity awareness among all stakeholders. Evidence: There is a high level of community engagement and understanding of cybersecurity challenges. Maintain and continuously enhance community awareness programs to align with evolving cybersecurity landscapes. 6. Legal/Risk Readiness Legal/Risk Readiness ensures the school district is prepared to manage the legal aspects and potential risks associated with the implementation and usage of Gen AI, encompassing legal remediation, risk management, and loss notification. The Maturity Rubric for this domain includes:",
            },
          },
        ],
      },
        ...
        subdomains: [
          {
            ...
            descriptions: {
              ...
              Developing: "Description: More structured processes for contractual compliance in Gen AI usage are developing, but not comprehensive. Evidence: Compliance with contractual terms has improved, but gaps in enforcement and monitoring exist. Recommendations: Enhance mechanisms to ensure thorough contract ual compliance for Gen AI usage.",
              Mature: "Description: Comprehensive and systematic processes are in place for ensuring contractual compliance in Gen AI usage. Evidence: Contractual terms are managed effectively, minimizing risks of non-compliance. Continuously review and adapt processes to maintain contractual compliance as Gen AI technologies evolve.",
            },
          },
          {
            id: "6.1.2",
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: Comprehensive and regular legal education on all aspects of Gen AI legal issues. Evidence: The legal team is wellinformed and up-to-date with Gen AI legal developments. Continuously update legal education programs to stay aligned with the latest Gen AI legal trends and challenges.",
            },
          },
          {
            id: "6.1.6",
        ...
        subdomains: [
          ...
          },
          {
            ...
            descriptions: {
              ...
              Developing: "Description: More comprehensive insurance coverage is developing for Gen AI-related risks, but not fully adequate. Some improvements in insurance coverage exist, but gaps in Gen AI risk coverage remain. Recommendations: Enhance insurance policies to fully cover all potential risks associated with Gen AI.",
          ...
          },
          {
            ...
            descriptions: {
              Emerging: "Description: There is an infrequent and basic review of insurance policies for Gen AI coverage. Insurance policies may not adequately cover the specific risks associated with Gen AI. Recommendations: Initiate a process for regular review of insurance policies to ensure adequate coverage for Gen AIrelated risks.",
              Developing: "Description: There is an increasing frequency of insurance policy reviews, but they do not fully address all Gen AI-related risks. Some improvements in insurance coverage for Gen AI have been made, but a comprehensive review is needed to cover all risks. Enhance the frequency and depth of insurance policy reviews to fully address Gen AI risks.",
    ...
    sections: [
      ...
      },
      {
        ...
        subdomains: [
          ...
          {
            id: "7.3.2",
            title: "Ethical Training: Providing indepth training for educators and staff on the ethical implic ations of AI, enhancing their understanding of responsible AI use and decision-making.",
            descriptions: {
        ...
        subdomains: [
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: Full inclusivity in AI tool access and usage, with advanced adaptations that ensure all students benefit equally from AI technologies. Evidence: Strong performance and satisfaction indicat ors across all student groups, with AI tools effectively supporting a wide range of needs. Recommendations: Continue to lead in the development and implementation of inclusive educational technologies. Share best practices and innovations with other districts and educational bodies.",
            },
          },
          {
            id: "7.5.3",
        ...
        subdomains: [
          ...
          },
          {
            ...
            descriptions: {
              ...
              Mature: "Description: Comprehensive use of AI in strategic planning, with AI systems fully integrated into the planning process, providing deep insights and forecasts. Evidence: AI is a key tool in formulating and adjusting strategy, clearly demonstrating value in optimizing outcomes and resource use. Recommendations: Continue to advance the use of AI in strategic planning. Stay abreast of developments in AI technology that could further enhance planning accuracy and effectiveness. Appendix 1 - Glossary of Terms Term Definition 1. AI Testing Framework for K-12 Standardization of protocols and procedures established to calibrate the functionality, efficiency, and effectiveness of AI tools in an educational setting. IT must ensure that AI applications are reliable, produce expected outcomes, and align with educational standards. This involves guarding against hyper or advantaged usage based on advanced knowledge or grade level. 2. 3rd party vendors Organizations that provide products or services to your organization under contract. 3. Algorithmic Discrimination Algorithmic discrimination occurs when automated systems contribute to unjustified differential treatment or impacts disfavoring people based on their race, color, ethnicity, sex (including pregnancy , childbirth, and related medical conditions, gender identity, intersex status, and sexual orientation), religion, age, national origin, disability, veteran status, genetic information, or any other classification protected by law. 4. Assets (Operational Readiness - Procurement section) Hardware and software purchases. 5. Compliant Gen AI tools vs Non-compliant Gen AI tools Compliance within an individual organizations established policies. 6. Copyright Protection Policy Under the Copyright Act, a copyright owner has the exclusive right to reproduce, adapt, distribute, publicly perform, and publicly display the work (or authorize others to do so). In the case of sound recordings, the copyright owner has the right to perform the work publicly through a digital audio transmission. Note: Content created by artificial intelligence without any human input cannot be copyrighted under current U.S. law. Term Definition 7. Data Classification Model A data classification model tags data according to its type, sensitivity, and value to the organization. It helps an organization understand the value of its data, determine whether the data is at risk, and implement controls to mitigate risks. 8. Data Sharing Partners External partners outside of 3rd party vendors that you contractually work with, such as community partners, non-profits, etc. 9. Data Steward An oversight role within an organization responsible for ensuring the quality and fitness for purpose of the organization's data assets. 10. Foundational Model A large machine learning model pre-trained on a vast quantity of data at scale resulting in a model that can be adapted to a wide range of downstream tasks. 11. Generative AI (Gen AI) A subset of artificial intelligence that leverages machine learning techniques to generate new content and ideas (conversations, stories, images, videos, music) that resemble your training data. 12. Generated Content Content generated by Gen AI machine learning systems that are capable of generating text, images, video, and other types of content. 13. Generative Liability & Insurance Requirements Student Accountability: Students who engage in nefarious activities can face disciplinary actions, including suspension and in severe cases, legal consequences. School Liability: If a school fails to monitor, prevent, or address malicious AI usage, it may face reputational harm, legal actions from affected parties, or potential financial consequences. Parental Responsibility: Depending on jurisdiction and the age of the student, parents or guardians may bear some legal or financial responsibility for their child's malicious actions. AI Vendor Responsibility: If an AI tool facilitates illegal or harmful actions due to its design or vulnerabilities, the vendor could be held partially responsible, especially if they failed to provide proper safeguards or warnings. Insurance requirements and parental/caregiving waivers should be strongly considered. Term Definition 14. Hallucinations of inappropriate content Instances when an AI generates unexpected, untrue results not backed by real-world data, including false content, news, or information about people, events, or facts. 15. Machine-Readable Format A digital representation of data or information in a file that can be  Legal/Risk Management, Section 3 Data Privacy Policy A Data Privacy Policy addresses the districts collection, use, and sharing of student and staff personal data in a manner that is consistent with applicable federal and state laws. It should be made available to all individuals whose personal data is covered by the policy. Data Readiness, Section 3 Data Loss Notification Policy A Data Loss Notification Policy is a set of guidelines that outlines the procedures for notifying affected parties in the event of a data breach. The policy should cover the notification process, including who should be notified, and what information should be included in the notification. The policy should also specify the roles and responsibilities of those involved in the notification process. Legal/Risk Management, Section 3 Policy Definition References AI RMF An AI Risk Management Framework is a policy or framework that would be specifically tailored to address the potential risks associated with the integration and use of artificial intelligence tools and technologies in primary and secondary education settings. Risk Management Ethical Considerations Policy An Ethical Considerations Policy outlines the understanding that AI respects students' rights and doesn't inadvertently harm or disadvantage any group of students. Fundamental Data Governance Policies Fundamental Data Governance Policies are foundational sets of guidelines and procedures established by a school district to ensure the consistent, secure, and lawful management and protection of data. Check out CoSNs Trusted Learning Environment seal recommended Fundamental Data Governance Policies. Data Readiness",
            },
          },
        ],
      },
